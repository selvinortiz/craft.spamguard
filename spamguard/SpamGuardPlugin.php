...
class SpamGuardPlugin extends BasePlugin
{
    ...
    {
        return array(
            'pluginName'		=> array(AttributeType::String, array('maxLength'=>50)),
            'pluginNickname' 	=> array(AttributeType::String, array('maxLength'=>50)),
            'akismetApiKey' 	=> array(AttributeType::String, array('maxLength'=>50)),
            'akismetOriginUrl'	=> array(AttributeType::String, array('maxLength'=>255))
        );
    }
    ...
    public function getSettingsHtml()
    {
        return craft()->templates->render(
            self::PLUGIN_HANDLE.'/settings.twig',
